...
namespace Factura
{
    class clsFactura
    {
        public class CreaTicket
        {
            ...
            {
                string LineEncavesado = "Producto         Cant   Precio    Total";   // agrega lineas de  encabezados
        ...
        public class RawPrinterHelper
        {
            ...
            public static bool SendBytesToPrinter(string szPrinterName, IntPtr pBytes, Int32 dwCount)
            {
                ...
                di.pDocName = "Factura";
                di.pDataType = "RAW";
               // di.pOutputFile = @"F:\Documentos\Programas Practica\Creacion de Factura\Imprimir";
